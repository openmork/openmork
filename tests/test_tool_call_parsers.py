...
class TestParserRegistry:
    ...
    def test_openmork_parser_registered(self):
        parsers = list_parsers()
        assert "openmork" in parsers
...
# ─── OPENMORK parser tests ────────────────────────────────────────────────

class TestOPENMORKParser:
    @pytest.fixture
    def parser(self):
        return get_parser("openmork")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["openmork"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use openmork format since that's universal
