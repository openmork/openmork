...
class TestWriteDenyExactPaths:
    ...
    def test_openmork_env(self):
        path = os.path.join(str(Path.home()), ".openmork", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_openmork_config_not_env(self):
        path = os.path.join(str(Path.home()), ".openmork", "config.yaml")
