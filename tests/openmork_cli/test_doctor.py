...
import openmork_cli.doctor as doctor
import openmork_cli.gateway as gateway_cli
from openmork_cli import doctor as doctor_mod
from openmork_cli.doctor import _has_provider_env_config
...
def test_run_doctor_sets_interactive_env_for_tool_checks(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(doctor_mod, "OPENMORK_HOME", openmork_home)
    monkeypatch.delenv("OPENMORK_INTERACTIVE", raising=False)

    seen = {}

    def fake_check_tool_availability(*args, **kwargs):
        seen["interactive"] = os.getenv("OPENMORK_INTERACTIVE")
        raise SystemExit(0)
