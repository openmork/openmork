"""Tests for the interactive session browser (`openmork sessions browse`).
...
from openmork_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """openmork sessions browse should be parseable."""
        from openmork_cli.main import main as _main_entry
