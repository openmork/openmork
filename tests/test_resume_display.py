...
class TestResumeDisplayConfig:
    ...
    def test_default_config_has_resume_display(self):
        """DEFAULT_CONFIG in openmork_cli/config.py includes resume_display."""
        from openmork_cli.config import DEFAULT_CONFIG
