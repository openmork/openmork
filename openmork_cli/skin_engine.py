"""OPENMORK CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.openmork/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "OpenMork"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ OPENMORK "       # Response box header label
...
.. code-block:: python
    ...
    from openmork_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "OpenMork"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.openmork/skins/
...
Drop a YAML file in ``~/.openmork/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    tool_prefix: str = "┊"
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces OPENMORK_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces OPENMORK_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic OPENMORK — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "OpenMork",
            "welcome": "Welcome to OpenMork! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ OPENMORK ",
            "prompt_symbol": "❯ ",
