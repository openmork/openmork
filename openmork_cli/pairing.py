...
Usage:
    openmork pairing list              # Show all pending + approved users
    openmork pairing approve <platform> <code>  # Approve a pairing code
    openmork pairing revoke <platform> <user_id> # Revoke user access
    openmork pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle openmork pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: openmork pairing {list|approve|revoke|clear-pending}")
        print("Run 'openmork pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(f"  Run 'openmork pairing list' to see pending codes.\n")
