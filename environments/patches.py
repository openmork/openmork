"""
Monkey patches for making OpenMork tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by openmork_base_env.py).
