...
class OPENMORKAgentEnvConfig(BaseEnvConfig):
    ...
    enabled_toolsets: Optional[List[str]] = Field(
        default=None,
        description="Explicit list of openmork toolsets to enable (e.g., ['terminal', 'file', 'web']). "
    ...
    tool_call_parser: str = Field(
        ...
        "Options: openmork, mistral, llama3_json, qwen, deepseek_v3, etc.",
    )
...
class OPENMORKAgentBaseEnv(BaseEnv):
    ...
    def __init__(
        ...
        # Set terminal environment variables so openmork tools pick them up.
