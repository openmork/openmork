...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("openmork")
        class OPENMORKToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "openmork", "mistral", "llama3_json")
...
from environments.tool_call_parsers.openmork_parser import OPENMORKToolCallParser  # noqa: E402, F401
