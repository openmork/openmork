...
> **Scope** Both integrations work correctly today. This spec is about the delta — patterns in OPENMORK that are worth propagating and patterns in openclaw-honcho that OPENMORK should eventually adopt. The spec is additive, not prescriptive.

---

## Architecture comparison

### OPENMORK: baked-in runner
...
Six patterns from OPENMORK are worth adopting in any Honcho integration. Each is described as an integration-agnostic interface.

**OPENMORK contributes:**
...
**openclaw-honcho contributes back (OPENMORK should adopt):**
...
- [ ] **honcho mode / sessions / map** — CLI parity with OPENMORK
...
Greenfield integration. Start from openclaw-honcho's architecture and apply all OPENMORK patterns from day one.
