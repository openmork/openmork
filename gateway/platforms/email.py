"""
Email platform adapter for the OPENMORK gateway.

Allows users to interact with OPENMORK by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "openmork")
        ...
        msg_id = f"<openmork-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
