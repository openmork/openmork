...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="ask", description="Ask OPENMORK a question")
        @discord.app_commands.describe(question="Your question for OPENMORK")
        ...
        @tree.command(name="reset", description="Reset your OPENMORK session")
        ...
        @tree.command(name="status", description="Show OPENMORK session status")
        ...
        @tree.command(name="thread", description="Create a new thread and start a OPENMORK session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to OPENMORK in the thread",
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new OPENMORK session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by OPENMORK: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "OPENMORK"
        if len(content) > 80:
