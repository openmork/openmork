...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full OPENMORK toolsets (CLI + messaging platforms)
    #
    ...
    "openmork-email": {
        "description": "Email bot toolset - interact with OPENMORK via email (IMAP/SMTP)",
        "tools": _OPENMORK_CORE_TOOLS,
        "includes": []
    },
    ...
    "openmork-gateway": {
        ...
        "tools": [],
        "includes": ["openmork-telegram", "openmork-discord", "openmork-whatsapp", "openmork-slack", "openmork-signal", "openmork-homeassistant", "openmork-email"]
    }
}
