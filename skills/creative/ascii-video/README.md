...
Built for [openmork](https://github.com/openmork/openmork). Usable in any coding agent. Canonical source lives here; synced to [`openmork/openmork/skills/creative/ascii-video`](https://github.com/openmork/openmork/tree/main/skills/creative/ascii-video) via PR.
