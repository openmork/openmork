...
```bash
python3 -m pyfiglet "OPENMORK" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=OPENMORK&font=Slant" | boxes -d stone
```
