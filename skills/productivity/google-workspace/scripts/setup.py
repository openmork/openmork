#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for OpenMork.
...
CLIENT_SECRET_PATH = OPENMORK_HOME / "google_client_secret.json"
PENDING_AUTH_PATH = OPENMORK_HOME / "google_oauth_pending.json"
...
def store_client_secret(path: str):
    """Copy and validate client_secret.json to OPENMORK home."""
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace OAuth setup for OPENMORK")
