---
sidebar_position: 7
title: "Use Voice Mode with OPENMORK"
description: "A practical guide to setting up and using OPENMORK voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with OPENMORK
...
- you want OPENMORK sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in OPENMORK.
...
## Step 1: make sure normal OPENMORK works first
...
OPENMORK supports both local and cloud speech stacks.
...
4. OPENMORK transcribes and responds
...
- asking OPENMORK to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full OPENMORK loop.

## Tuning CLI behavior

### Silence threshold

If OPENMORK starts/stops too aggressively, tune:
...
OPENMORK stays a normal chat bot, but can speak replies.
...
- you want OPENMORK to function like a portable research or ops assistant
...
OPENMORK joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- OPENMORK detects speech boundaries
- transcripts are posted in the associated text channel
- OPENMORK responds in text and audio
